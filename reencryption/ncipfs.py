...
#         alice.start_learning_loop(now=True)
    ...
    def add_data_and_grant_self_access(self, username, password, label, contents, alice_obj):
        print("add_data_and_grant_self_access")
...
n.connect("127.0.0.1:10151","127.0.0.1:8080")

alice_obj = n.create_new_user("vedhant", "passwordpassword123456")

my_nucid = n.add_data_and_grant_self_access("vedhant", "passwordpassword123456",
                              "README.md", "hello world", alice_obj)
